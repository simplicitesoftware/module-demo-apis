...
public class DemoAPI2 extends com.simplicite.webapp.services.RESTServiceExternalObject {
    ...
    public JSONArray searchObjectRecords(
        ...
        try {
            ...
            List<String[]> rows = obj.search(filters == null ? new JSONObject() : filters); // filtered search
     ...
     * @throws SearchException if get fails
 	 */
    ...
    public JSONObject getObjectRecord(
        ...
        try {
            ...
            List<String[]> rows = obj.search(new JSONObject().put(field, value)); // filtered search using reference only
